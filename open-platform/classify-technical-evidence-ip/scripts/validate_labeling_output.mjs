...
const required = ["Source Data", "Labeling Results", "Evidence", "Review Queue", "Taxonomy Backlog", "Taxonomy", "Decision Rules", "QA Summary", "Task Info", "MCP Provenance"];
...
const report = {
  ...
  metrics: {
    ...
    review_queue_rows: objects("Review Queue").length,
    taxonomy_backlog_rows: objects("Taxonomy Backlog").length,
  },
  errors,
};
