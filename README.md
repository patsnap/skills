...
| Open Platform | `open-platform/` | 119 | Skill Hub imported workflows for IP, R&D, engineering, life sciences, reports, FTO, patent operations, technology transfer and vertical intelligence. |

## Open Platform Imports

The 2026-06-30, 2026-07-03 and 2026-07-09 Skill Hub batches have been normalized into the top-level `open-platform/` directory instead of being mixed into the core domain directories.
...
| Additional skill-20 batch | 20 |
| Total imported skill directories | 119 |
